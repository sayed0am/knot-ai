...
# Anthropic has the strictest documented identifier alphabet among knot's
...
def portable_tool_call_id(value: str) -> str:
    ...
    preserving same-provider cache/replay behavior. Other IDs are hashed
    rather than character-replaced so distinct native IDs cannot collapse
    together.
    """
