...
from knot.providers._provider_events import ProviderRetryEvent
...
def is_transient_status(status_code: int) -> bool:
    """Return whether an HTTP status code is transient and safe to retry."""
...
async def wait_for_retry(
    ...
    *,
    ...
    Returns ``False`` if the request was cancelled during the wait.
    """
    if delay_seconds <= 0:
