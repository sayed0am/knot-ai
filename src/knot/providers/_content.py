...
from knot.providers.messages import ImageContent, TextContent, ToolResultMessage, UserMessage
...
NON_VISION_TOOL_IMAGE_PLACEHOLDER = (
    ...
    "unavailable—do not infer or describe them; ask the user to switch to a vision-capable "
    "model)"
)
